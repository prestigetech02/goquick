...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-white text-slate-900">
      ...
      <main className="site-container pb-16 pt-28 sm:pt-32">
        <div className="mx-auto max-w-5xl">
          <section
            className="relative overflow-hidden rounded-2xl px-4 pt-6 py-0.5 sm:px-6 sm:pt-1 sm:py-1 md:px-10 md:py-2 lg:px-14 lg:py-2"
            ...
            <div className="relative grid grid-cols-1 items-center gap-10 lg:grid-cols-2 lg:gap-14">
              <div className="space-y-6 text-white">
                ...
                <p className="max-w-md text-base text-white/90 sm:text-xl">
                  We&apos;re building the platform people turn to for everyday errands, so you can focus on what matters most.
                </p>
          ...
          <div className="mt-16 w-full">
            <section className="mb-16">
              <h2 className="text-lg font-bold text-slate-900 sm:text-2xl">Who we are</h2>
            ...
            <div className="mb-16 grid gap-6 sm:grid-cols-2 sm:gap-8">
              <section className="rounded-2xl border border-slate-200 bg-slate-50/50 p-6 sm:p-8">
                ...
                <p className="mt-4 text-slate-600">
                  To give you back your time by making errands simple, fast, and without the stress. We want every user to feel
            ...
            <section className="mb-16">
              <h2 className="text-lg font-bold text-slate-900 sm:text-2xl">What we do</h2>
              <p className="mt-4 text-slate-600">
            ...
            <section className="mb-16">
              <h2 className="text-lg font-bold text-slate-900 sm:text-2xl">Why choose us</h2>
              <ul className="mt-6 space-y-4">
                ...
                <li className="flex gap-3">
                  <span className="mt-0.5 shrink-0 font-bold text-[var(--primary)]" aria-hidden>•</span>
                  <div>
                    <strong className="text-slate-800">Live tracking</strong>
            ...
            <section className="rounded-2xl border border-slate-200 bg-slate-50/50 p-6 text-center sm:p-8">
              <h2 className="text-lg font-bold text-slate-900 sm:text-2xl">Get started today</h2>
              <p className="mt-3 text-slate-600">
                Request your first errand on the web, or download the runner app and start earning.
              </p>
